...
ALTER TABLE restaurant.customers ENABLE CHANGE_TRACKING;
ALTER TABLE restaurant.historical_orders ENABLE CHANGE_TRACKING;
ALTER TABLE restaurant.menu_items ENABLE CHANGE_TRACKING;
ALTER TABLE restaurant.restaurants ENABLE CHANGE_TRACKING;
ALTER TABLE restaurant.reviews ENABLE CHANGE_TRACKING;

EXEC sys.sp_cdc_enable_db;

EXEC sys.sp_cdc_enable_table
    @source_schema = N'restaurant',
